    ...
    <div className="relative">
      ...
      {showInfo && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          className="absolute top-full left-0 mt-2 z-50 min-w-64 rounded-lg border border-surface-700 bg-surface-800 p-4 shadow-xl animate-in fade-in slide-in-from-top-2 duration-150"
        >
