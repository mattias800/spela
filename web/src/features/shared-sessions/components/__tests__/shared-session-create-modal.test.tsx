...
import { SharedSessionCreateModal } from "../shared-session-create-modal";

const mockMutate = vi.fn();

vi.mock("@/hooks/use-shared-sessions", () => ({
  useCreateSharedSession: vi.fn(() => ({
    mutate: mockMutate,
    isPending: false,
  })),
}));
...
describe("SharedSessionCreateModal", () => {
  it("renders form fields when open", () => {
    ...
    // "Create Shared Session" appears as both modal title and submit button
    expect(screen.getAllByText("Create Shared Session")).toHaveLength(2);
  });
  ...
  it("disables submit when name is empty", () => {
    ...
    const submitButton = screen
      .getAllByText("Create Shared Session")
