  ...
  return (
    ...
    >
      <p className="text-sm text-surface-300 mb-6">
        This will permanently delete <strong className="text-surface-100">{user?.username}</strong> and all their data (saves, favorites, play history). This action cannot be undone.
      </p>
