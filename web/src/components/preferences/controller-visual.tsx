    ...
    <div data-testid="controller-visual" className="bg-surface-900 border border-surface-800 rounded-xl p-5">
      ...
      <div className="flex justify-between items-center px-4">
        ...
        <div className="flex flex-col items-center gap-0.5">
          <span className="text-[10px] uppercase tracking-wider text-surface-500 mb-1">D-Pad</span>
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex gap-3">
            <div className="text-center">
              <span className="text-[10px] uppercase tracking-wider text-surface-500 block mb-1">Select</span>
            ...
            <div className="text-center">
              <span className="text-[10px] uppercase tracking-wider text-surface-500 block mb-1">Start</span>
              <span className="inline-flex items-center justify-center min-w-[2.5rem] px-1.5 py-1 rounded bg-surface-800 border border-surface-700 text-xs font-mono text-surface-200">
        ...
        {/* Face buttons */}
        <div className="flex flex-col items-center gap-0.5">
          <span className="text-[10px] uppercase tracking-wider text-surface-500 mb-1">Face</span>
          <div className="grid grid-cols-3 gap-0.5 w-24">
            <div />
            <div className="flex items-center justify-center h-7 rounded bg-surface-800 border border-surface-700 text-xs font-mono text-surface-200">
