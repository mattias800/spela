import { Card, CardHeader, CardContent, Skeleton, Switch } from "@/components/ui";
import type { UserPreferences } from "@/types/api";

interface EmulationSettingsCardProps {
  preferences: UserPreferences | undefined;
  isLoading: boolean;
  onToggle: (key: "showPerformanceOverlay" | "autoSaveEnabled" | "autoLoadSaveEnabled") => void;
}
...
export function EmulationSettingsCard({ preferences, isLoading, onToggle }: EmulationSettingsCardProps) {
  return (
    <Card>
      <CardHeader>
