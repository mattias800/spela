...
type consoleMetadata struct {
	...
	UnitsSold    *int64
	Summary      *string
	// Tag is an optional short card qualifier (e.g. "Demos"); nil leaves
	// the console untagged.
	Tag *string
}
...
func SeedConsoleMetadata(db *gorm.DB) error {
	metadata := []consoleMetadata{
		...
		// 1st Generation
		{Abbreviation: "GW", Code: "gw", MakerCode: "nintendo", MediaCode: "digital", ReleaseYear: intPtr(1980), UnitsSold: int64Ptr(43400000), Summary: strPtr("Nintendo Game & Watch was a line of handheld electronic games created by Gunpei Yokoi, featuring LCD screens with fixed game graphics. Spanning 59 models from 1980 to 1991, they introduced the cross-shaped directional pad that became standard on all subsequent Nintendo controllers.")},

		// 2nd Generation
		{Abbreviation: "CHAF", Code: "channelf", MakerCode: "fairchild", MediaCode: "cartridge", ReleaseYear: intPtr(1976), UnitsSold: int64Ptr(250000), Summary: strPtr("The Fairchild Channel F was the first home video game console to use programmable ROM cartridges, predating the Atari 2600 by a year. While commercially overshadowed by Atari, it pioneered the concept of interchangeable game cartridges that defined the industry for decades.")},
		{Abbreviation: "O2", Code: "odyssey2", MakerCode: "magnavox", MediaCode: "cartridge", ReleaseYear: intPtr(1978), UnitsSold: int64Ptr(2000000), Summary: strPtr("The Magnavox Odyssey 2, known as the Philips Videopac G7000 in Europe, featured a built-in membrane keyboard that set it apart from competitors. Its unique combination of gaming and limited computing capabilities made it popular in Europe, though it struggled against the Atari 2600 in North America.")},
		{Abbreviation: "INTV", Code: "intellivision", MakerCode: "mattel", MediaCode: "cartridge", ReleaseYear: intPtr(1979), UnitsSold: int64Ptr(3000000), Summary: strPtr("The Mattel Intellivision was the first console to pose a serious challenge to Atari's dominance, featuring superior graphics and distinctive disc-shaped controllers with numeric keypads. Its sports games were particularly acclaimed, and it introduced the concept of downloadable content through the PlayCable service.")},
		{Abbreviation: "VEC", Code: "vectrex", MakerCode: "gce", MediaCode: "cartridge", ReleaseYear: intPtr(1982), UnitsSold: nil, Summary: strPtr("The GCE Vectrex was unique among home consoles for its built-in vector display monitor, producing crisp line graphics similar to arcade games like Asteroids and Tempest. Despite critical acclaim and innovative accessories including a 3D imager, it was discontinued after the 1983 video game crash.")},

		// 3rd Generation
		{Abbreviation: "FDS", Code: "fds", MakerCode: "nintendo", MediaCode: "floppy-disk", ReleaseYear: intPtr(1986), UnitsSold: int64Ptr(4440000), Summary: strPtr("The Famicom Disk System was a Japan-exclusive add-on for the Famicom that used rewritable floppy disks, enabling larger games, saved data, and lower-cost distribution through disk-rewriting kiosks. It debuted landmark titles including the original versions of The Legend of Zelda, Metroid, and Kid Icarus.")},
		{Abbreviation: "SG1K", Code: "sg1000", MakerCode: "sega", MediaCode: "cartridge", ReleaseYear: intPtr(1983), UnitsSold: nil, Summary: strPtr("The Sega SG-1000 was Sega's first home console, launched in Japan on the same day as the Nintendo Famicom. While it was commercially overshadowed by Nintendo, it established Sega in the console market and its hardware architecture evolved directly into the more successful Sega Master System.")},
		...
		{Abbreviation: "SGX", Code: "sgx", MakerCode: "nec", MediaCode: "hucard", ReleaseYear: intPtr(1989), UnitsSold: nil, Summary: strPtr("The PC Engine SuperGrafx was an enhanced version of the PC Engine with additional video hardware for improved sprite and background capabilities. Only seven games were released specifically for the system, making it one of the shortest-lived and rarest consoles, though it maintained full backward compatibility with the original PC Engine library.")},
		...
		// 8th Generation
		{Abbreviation: "VITA", Code: "vita", MakerCode: "sony", MediaCode: "game-card", ReleaseYear: intPtr(2011), UnitsSold: int64Ptr(15900000), Summary: strPtr("The PlayStation Vita was Sony's second handheld console, featuring a 5-inch OLED touchscreen, rear touchpad, and dual analog sticks. Despite powerful hardware capable of near-PS3 quality visuals, it struggled against mobile gaming competition, though it found a devoted audience for its strong library of JRPGs, indie games, and remote play functionality.")},
		...
		{Abbreviation: "A800", Code: "a800", MakerCode: "atari", MediaCode: "cartridge", ReleaseYear: intPtr(1979), UnitsSold: nil, Summary: strPtr("The Atari 8-bit family, starting with the Atari 400 and 800, featured custom chips designed by Jay Miner that provided advanced graphics and sound capabilities for their era. The line evolved through the XL and XE series, building a strong library of games and creative software that influenced a generation of programmers and game designers.")},
		{Abbreviation: "ATARIST", Code: "atarist", MakerCode: "atari", MediaCode: "floppy-disk", ReleaseYear: intPtr(1985), UnitsSold: nil, Summary: strPtr("The Atari ST was a popular 16/32-bit home computer that rivaled the Commodore Amiga, particularly in Europe. Its built-in MIDI ports made it the standard platform for music production throughout the late 1980s and early 1990s, while also hosting a strong library of games and creative software.")},
