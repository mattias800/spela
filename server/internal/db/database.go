...
func SeedConsoles(db *gorm.DB) error {
	consoles := []Console{
		// 3rd Generation
		{Name: "Nintendo Entertainment System", Abbreviation: "NES", Extensions: ".nes,.fds", DefaultCore: "nestopia", EmulatorJSCore: "nestopia", FolderName: "nes", ColorTheme: "#e60012", CoverAspect: "5:7", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Famicom Disk System", Abbreviation: "FDS", Extensions: ".fds", DefaultCore: "nestopia", EmulatorJSCore: "nestopia", FolderName: "fds", ColorTheme: "#e60012", CoverAspect: "1:1", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Sega Master System", Abbreviation: "SMS", Extensions: ".sms", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaMS", FolderName: "mastersystem", ColorTheme: "#0060a8", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Sega SG-1000", Abbreviation: "SG1K", Extensions: ".sg,.sc,.sf7,.bin", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaMS", FolderName: "sg-1000", ColorTheme: "#0060a8", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Atari 7800", Abbreviation: "A78", Extensions: ".a78,.bin", DefaultCore: "prosystem", EmulatorJSCore: "prosystem", FolderName: "atari7800", ColorTheme: "#1c1c1c", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		// 4th Generation
		{Name: "Super Nintendo", Abbreviation: "SNES", Extensions: ".sfc,.smc", DefaultCore: "snes9x", EmulatorJSCore: "snes9x", FolderName: "snes", ColorTheme: "#7b7db5", CoverAspect: "4:3", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Sega Genesis", Abbreviation: "GEN", Extensions: ".md,.gen,.bin", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaMD", FolderName: "genesis", ColorTheme: "#1565c0", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Game Boy", Abbreviation: "GB", Extensions: ".gb", DefaultCore: "gambatte", EmulatorJSCore: "gambatte", FolderName: "gb", ColorTheme: "#2e3a08", CoverAspect: "7:8", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Game Gear", Abbreviation: "GG", Extensions: ".gg", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaGG", FolderName: "gamegear", ColorTheme: "#1a1a1a", CoverAspect: "1:1", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "TurboGrafx-16", Abbreviation: "PCE", Extensions: ".pce", DefaultCore: "mednafen_pce", EmulatorJSCore: "mednafen_pce", FolderName: "tg16", ColorTheme: "#ff6600", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "TurboGrafx-CD", Abbreviation: "PCECD", Extensions: ".chd,.cue,.iso,.m3u", DefaultCore: "mednafen_pce", EmulatorJSCore: "mednafen_pce", FolderName: "tg16cd", ColorTheme: "#ff6600", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "PC Engine SuperGrafx", Abbreviation: "SGX", Extensions: ".sgx,.pce", DefaultCore: "mednafen_supergrafx", EmulatorJSCore: "", FolderName: "supergrafx", ColorTheme: "#ff6600", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Neo Geo CD", Abbreviation: "NEOCD", Extensions: ".chd,.cue,.iso", DefaultCore: "neocd", EmulatorJSCore: "", FolderName: "neogeocd", ColorTheme: "#1c1c1c", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		// catches up.
		{Name: "Sega CD", Abbreviation: "SCD", Extensions: ".iso,.bin,.cue,.m3u", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaCD", FolderName: "segacd", ColorTheme: "#0a8d7b", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Game Boy Color", Abbreviation: "GBC", Extensions: ".gbc", DefaultCore: "gambatte", EmulatorJSCore: "gambatte", FolderName: "gbc", ColorTheme: "#5c1230", CoverAspect: "7:8", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Atari Jaguar", Abbreviation: "JAG", Extensions: ".j64,.jag", DefaultCore: "virtualjaguar", EmulatorJSCore: "virtualjaguar", FolderName: "atarijaguar", ColorTheme: "#1c1c1c", Generation: 5, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Virtual Boy", Abbreviation: "VB", Extensions: ".vb,.vboy", DefaultCore: "beetle_vb", EmulatorJSCore: "beetle_vb", FolderName: "virtualboy", ColorTheme: "#1c1c1c", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Neo Geo Pocket / Color", Abbreviation: "NGP", Extensions: ".ngp,.ngc", DefaultCore: "beetle_ngp", EmulatorJSCore: "mednafen_ngp", FolderName: "ngp", ColorTheme: "#1a75bc", CoverAspect: "1:1", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "WonderSwan", Abbreviation: "WS", Extensions: ".ws,.wsc", DefaultCore: "beetle_wswan", EmulatorJSCore: "mednafen_wswan", FolderName: "wonderswan", ColorTheme: "#4b0082", CoverAspect: "1:1", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Sega 32X", Abbreviation: "32X", Extensions: ".32x", DefaultCore: "picodrive", EmulatorJSCore: "sega32x", FolderName: "sega32x", ColorTheme: "#1a1a1a", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "PC-FX", Abbreviation: "PCFX", Extensions: ".iso,.cue,.m3u", DefaultCore: "beetle_pcfx", EmulatorJSCore: "mednafen_pcfx", FolderName: "pcfx", ColorTheme: "#ff6600", Generation: 5, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Amiga CD32", Abbreviation: "ACD32", Extensions: ".iso,.cue,.bin,.chd", DefaultCore: "", EmulatorJSCore: "", FolderName: "acd32", ColorTheme: "#c47d1a", CoverAspect: "8:11", Generation: 5, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicySmall, Playable: false},
		// 6th Generation
		{Name: "PlayStation 2", Abbreviation: "PS2", Extensions: ".iso,.bin,.cue,.chd,.m3u", DefaultCore: "play", EmulatorJSCore: "", FolderName: "ps2", ColorTheme: "#003087", Generation: 6, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicyLarge, Playable: true},
		{Name: "Dreamcast", Abbreviation: "DC", Extensions: ".gdi,.cdi,.chd,.cue,.bin,.m3u", DefaultCore: "flycast", EmulatorJSCore: "", FolderName: "dreamcast", ColorTheme: "#c0c0c0", Generation: 6, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicyMedium, Playable: true},
		{Name: "Nintendo GameCube", Abbreviation: "GC", Extensions: ".iso,.gcm,.gcz,.ciso,.rvz", DefaultCore: "dolphin", EmulatorJSCore: "", FolderName: "gc", ColorTheme: "#6f5fa6", CoverAspect: "1:1", Generation: 6, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicyLarge, Playable: true},
		{Name: "Game Boy Advance", Abbreviation: "GBA", Extensions: ".gba", DefaultCore: "mgba", EmulatorJSCore: "mgba", FolderName: "gba", ColorTheme: "#2e17a3", CoverAspect: "1:1", Generation: 6, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "PlayStation Portable", Abbreviation: "PSP", Extensions: ".iso,.cso,.chd", DefaultCore: "ppsspp", EmulatorJSCore: "ppsspp", FolderName: "psp", ColorTheme: "#455a8a", Generation: 7, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicyMedium, Playable: true},
		{Name: "Nintendo DS", Abbreviation: "NDS", Extensions: ".nds", DefaultCore: "desmume", EmulatorJSCore: "desmume", FolderName: "nds", ColorTheme: "#b0b0b0", CoverAspect: "10:9", Generation: 7, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicyMedium, Playable: true},
		// 8th Generation
		{Name: "Nintendo Wii U", Abbreviation: "WIIU", Extensions: ".rpx,.wud,.wux", DefaultCore: "", EmulatorJSCore: "", FolderName: "wiiu", ColorTheme: "#009ac7", CoverAspect: "8:11", Generation: 8, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicyLarge, Playable: false},
		...
		{Name: "Xbox Series", Abbreviation: "XSX", Extensions: ".xvd", DefaultCore: "", EmulatorJSCore: "", FolderName: "xboxseries", ColorTheme: "#107c10", CoverAspect: "8:11", Generation: 9, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicyLarge, Playable: false},
		// 2nd Generation
		{Name: "Atari 2600", Abbreviation: "A26", Extensions: ".a26,.bin", DefaultCore: "stella", EmulatorJSCore: "stella2014", FolderName: "atari2600", ColorTheme: "#8b4513", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Atari 5200", Abbreviation: "A52", Extensions: ".a52,.bin", DefaultCore: "atari800", EmulatorJSCore: "", FolderName: "atari5200", ColorTheme: "#1c1c1c", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "ColecoVision", Abbreviation: "CV", Extensions: ".col,.rom", DefaultCore: "gearcoleco", EmulatorJSCore: "gearcoleco", FolderName: "colecovision", ColorTheme: "#1565c0", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Fairchild Channel F", Abbreviation: "CHAF", Extensions: ".bin,.chf", DefaultCore: "freechaf", EmulatorJSCore: "", FolderName: "channelf", ColorTheme: "#cc6600", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Magnavox Odyssey 2", Abbreviation: "O2", Extensions: ".bin,.o2", DefaultCore: "o2em", EmulatorJSCore: "", FolderName: "odyssey2", ColorTheme: "#b8860b", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Mattel Intellivision", Abbreviation: "INTV", Extensions: ".int,.bin,.rom", DefaultCore: "freeintv", EmulatorJSCore: "", FolderName: "intellivision", ColorTheme: "#c47d1a", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "GCE Vectrex", Abbreviation: "VEC", Extensions: ".bin,.vec", DefaultCore: "vecx", EmulatorJSCore: "", FolderName: "vectrex", ColorTheme: "#333333", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Atari 8-bit", Abbreviation: "A800", Extensions: ".a52,.atr,.atx,.bas,.bin,.car,.cas,.com,.rom,.xex,.xfd", DefaultCore: "atari800", EmulatorJSCore: "", FolderName: "atari800", ColorTheme: "#1c1c1c", Generation: 100, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Commodore Amiga", Abbreviation: "AMIGA", Extensions: ".adf,.hdf,.lha,.dms,.zip", DefaultCore: "puae", EmulatorJSCore: "puae", FolderName: "amiga", ColorTheme: "#c47d1a", Generation: 100, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "Amiga Demos", Abbreviation: "ADEMO", Extensions: ".adf,.hdf,.lha,.dms,.zip", DefaultCore: "puae", EmulatorJSCore: "puae", FolderName: "amiga-demos", ColorTheme: "#c47d1a", Generation: 100, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Arcade", Abbreviation: "ARCADE", Extensions: ".zip", DefaultCore: "mame2003_plus", EmulatorJSCore: "fbneo", FolderName: "arcade", ColorTheme: "#0a8d7b", Generation: 101, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
