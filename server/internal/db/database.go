...
func SeedConsoles(db *gorm.DB) error {
	consoles := []Console{
		...
		{Name: "Atari 7800", Abbreviation: "A78", Extensions: ".a78,.bin", DefaultCore: "prosystem", EmulatorJSCore: "prosystem", FolderName: "atari7800", ColorTheme: "#8b4513", Generation: 3, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		// 4th Generation
		...
		{Name: "Sega Genesis", Abbreviation: "GEN", Extensions: ".md,.gen,.bin", DefaultCore: "genesis_plus_gx", EmulatorJSCore: "segaMD", FolderName: "genesis", ColorTheme: "#171717", Generation: 4, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Amiga CD32", Abbreviation: "ACD32", Extensions: ".iso,.cue,.bin,.chd", DefaultCore: "", EmulatorJSCore: "", FolderName: "acd32", ColorTheme: "#6c5eb5", CoverAspect: "8:11", Generation: 5, SaveStateSupport: false, SaveStatePolicy: SaveStatePolicySmall, Playable: false},
		// 6th Generation
		...
		{Name: "Atari 5200", Abbreviation: "A52", Extensions: ".a52,.bin", DefaultCore: "atari800", EmulatorJSCore: "", FolderName: "atari5200", ColorTheme: "#8b4513", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		{Name: "ColecoVision", Abbreviation: "CV", Extensions: ".col,.rom", DefaultCore: "gearcoleco", EmulatorJSCore: "gearcoleco", FolderName: "colecovision", ColorTheme: "#000000", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
		...
		{Name: "Mattel Intellivision", Abbreviation: "INTV", Extensions: ".int,.bin,.rom", DefaultCore: "freeintv", EmulatorJSCore: "", FolderName: "intellivision", ColorTheme: "#8b6914", Generation: 2, SaveStateSupport: true, SaveStatePolicy: SaveStatePolicySmall, Playable: true},
