...
func (h *SessionHandler) toSessionResponse(s db.GameSession, saveCount int) GameSessionResponse {
	...
	return GameSessionResponse{
		...
		CoreName:              s.CoreName,
		PinnedCoreSha256:      s.PinnedCoreSha256,
		UserLockedCoreVersion: s.UserLockedCoreVersion,
		AutoLoadSuppressed:    s.AutoLoadSuppressed,
		RehearsalCrashPending: s.RehearsalCrashPending,
