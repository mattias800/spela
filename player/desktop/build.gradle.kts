...
val desktopTestShardWeightOverrides = mapOf(
    ...
    "com.spela.player.desktop.e2e.OnboardingWizardTest" to 24,
    "com.spela.player.desktop.e2e.InGameOverlayTest" to 20,
    "com.spela.player.desktop.e2e.ScrollRestorationTest" to 30,
    "com.spela.player.desktop.e2e.AppLaunchAndConnectionTest" to 15,
    "com.spela.player.desktop.e2e.SessionDetailUiTest" to 13,
    "com.spela.player.desktop.e2e.NetplayInviteTest" to 11,
    "com.spela.player.desktop.e2e.SessionsUiTest" to 17,
    "com.spela.player.desktop.e2e.EscapeKeyOverlayTest" to 6,
    "com.spela.player.desktop.e2e.LazyCarouselFocusRestoreTest" to 20,
    "com.spela.player.desktop.e2e.BiosWarningTest" to 15,
    "com.spela.player.desktop.e2e.GlobalSearchTest" to 17,
    "com.spela.player.desktop.e2e.ResumeVsNewGameTest" to 10,
    "com.spela.player.desktop.e2e.GameDetailActionsMenuTest" to 7,
    "com.spela.player.desktop.e2e.GameDetailCommunitySectionsTest" to 8,
    "com.spela.player.desktop.e2e.CreateChallengeTest" to 3,
    "com.spela.player.desktop.e2e.ChallengeCreationTest" to 8,
    "com.spela.player.desktop.e2e.GamepadMappingTest" to 7,
    "com.spela.player.desktop.e2e.GameDetailAchievementsTest" to 8,
