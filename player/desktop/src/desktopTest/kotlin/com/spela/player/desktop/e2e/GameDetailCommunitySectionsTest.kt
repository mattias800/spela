...
class GameDetailCommunitySectionsTest {
    ...
    @Test
    fun communityStatsShowsTopPlayersAndNavigatesToUserProfile() = runComposeUiTest {
        ...
        harness.gameStatsRepo.gameStats = GameStats(
            ...
            topPlayers = listOf(
                TopPlayer("user-42", "SpeedKing", null, 120000),
                TopPlayer("user-43", "CasualGamer", null, 90000),
                TopPlayer("user-44", "Newbie", null, 60000),
            ),
        )
        ...
        onNodeWithText("SpeedKing").assertIsDisplayed()
    ...
    @Test
    fun reviewsSectionShowsReviewsAndHidesLoadMoreWhenAllLoaded() = runComposeUiTest {
        val harness = createHarnessOnGameDetail()
    ...
    @Test
    fun sharedSessionsSectionShowsSharedSessionsAndClickableItems() = runComposeUiTest {
        val harness = createHarnessOnGameDetail()
