                ...
                addHandler { request ->
                    ...
                    when {
                        path.endsWith("/api/consoles") -> respond(
                            ...
                            """[{"id":"1","name":"NES","abbreviation":"nes","code":"nes","gameCount":5,"colorTheme":"#e74c3c","coverAspectRatio":0.72,"logoAspectRatio":null,"defaultCore":"fceumm","emulatorJsCore":"fceumm","extensions":["nes"],"generation":3,"iconUrl":"/images/nes.png","logoUrl":"/images/nes.svg","logoPngUrl":"/images/nes.png","photoUrl":null,"tag":null,"saveStateSupport":true,"saveStatePolicy":"small","browserPlayable":true,"playable":true,"maker":{"code":"nintendo","name":"Nintendo"},"mediaType":{"code":"cart","name":"Cartridge","category":{"code":"physical","name":"Physical"}},"releaseYear":1983,"summary":"8-bit classic","unitsSold":61900000,"createdAt":"2024-01-01T00:00:00Z","updatedAt":"2024-01-01T00:00:00Z"}]""",
                            HttpStatusCode.OK,
