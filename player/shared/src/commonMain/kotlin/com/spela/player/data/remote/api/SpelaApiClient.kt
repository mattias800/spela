...
class SpelaApiClient(
    ...
    suspend fun getFederationStats(
        metric: com.spela.client.apis.FederationApi.MetricFederationAggregatedStats,
    ): com.spela.client.models.AggregatedStatsOutputBody {
